Contributing to Anthem Portal (Demo) APD
=======================================

Summary
-------
This document covers how to contribute to the APD project. APD uses github PRs to manage code contributions. 
...
In your browser, navigate to: [https://github.com/openanthem/portal](https://github.com/openanthem/portal)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/portal.git
$ cd cloudstack
$ git remote add upstream https://github.com/openanthem/portal.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/portal](https://github.com/YOUR_ACCOUNT/portal)
